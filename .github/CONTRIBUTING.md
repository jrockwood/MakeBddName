...
* Please **do not** open issues or pull requests which *belong to* third party
  components.
...
> 3. Further steps, etc.
>
> `<url>` - a link to the project/file uploaded on cloud storage or other
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/jrockwood/<this-repro-name>.git
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   to the commit message. For instance: "SCSS: Fix compiler results for IFileListener.\nFix `#123`"
...
- Before committing, organize usings for each updated C# source file. Either you can
  right-click editor and select `Organize Usings > Remove and sort` OR use an extension
  like [CodeMaid](https://visualstudiogallery.msdn.microsoft.com/76293c4d-8c16-4f4a-aee6-21f83a571496).
